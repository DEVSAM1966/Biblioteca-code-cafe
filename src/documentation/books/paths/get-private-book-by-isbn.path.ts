...
export const GetPrivateBookByIsbnPath: OpenAPIV3.PathsObject = {
  '/books/private/isbn/{isbn}': {
    get: {
      tags: ['Books'],
      summary: 'Get private book by ISBN',
      description:
        'Retrieves a single book by its ISBN. Requires authentication with roles ADMIN, SUPPORT, or USER.',
      security: [
        {
          bearerAuth: [],
        },
        ...
        500: {
          ...
          content: {
            'application/json': {
              schema: FailureResponse({
                type: 'string',
                example: 'Failed to retrieve private book by ISBN',
              }),
            },
          },
        },
