...
export const UpdateBookFilesPath: OpenAPIV3.PathsObject = {
  '/books/{isbn}/files': {
    put: {
      ...
      description:
        'Updates the cover and/or file of a book by ISBN. Requires multipart/form-data with valid files. ' +
            ...
            'application/json': {
              ...
              examples: {
                ...
                invalidFileType: {
                  value: {
                    error:
                      'Invalid file type for bookCover. Allowed types: image/jpeg, image/png, image/webp',
                    timestamp: new Date().toISOString(),
                  },
                },
              },
