...
export const DeleteUserPath: OpenAPIV3.PathsObject = {
  '/users/id/{id}': {
    delete: {
      ...
      description:
        'Deletes a user by its numeric ID. Returns success if the user was deleted. Throws error if the ID is invalid, the user does not exist, or has related records that prevent deletion.',
      parameters: [
        {
          name: 'id',
          in: 'path',
